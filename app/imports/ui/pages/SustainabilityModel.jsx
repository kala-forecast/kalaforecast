...
const SustainabilityModel = () => (
  <Container id={PAGE_IDS.SUSTAINABILITY_MODEL} className="py-3" align="center">
    ...
    <Table striped bordered hover>
      ...
      <tbody>
        <tr>
          <th colSpan="13" className="text-center" style={{ backgroundColor: 'lightblue' }}>INCOME STATEMENT</th>
        </tr>
        <tr>
          <th>Revenue</th>
        </tr>
        ...
        <tr>
          <th colSpan="13" className="text-center" style={{ backgroundColor: 'lightblue' }}>BALANCE SHEET</th>
        </tr>
        <tr>
